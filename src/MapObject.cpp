...
MapObject::MapObject(CartesianCoordinates coordinates, const ObjectSize dimensions, SDL_Texture *texture, ObjectType type)
    ...
    if (RenderElement::renderer) {
        if (background || true) {
			...
			case ObjectType::BASE:
				SDL_RenderCopy(RenderElement::renderer, RenderElement::texture_lib->GetTexture(TextureLib::TextureEnum::base), nullptr, &quad);
				break;
			case ObjectType::MINIONMEDIUM:
				SDL_RenderCopy(RenderElement::renderer, RenderElement::texture_lib->GetTexture(TextureLib::TextureEnum::minion), nullptr, &quad);
				break;
			case ObjectType::MINIONREMI:
				SDL_RenderCopy(RenderElement::renderer, RenderElement::texture_lib->GetTexture(TextureLib::TextureEnum::remi), nullptr, &quad);
				break;
			case ObjectType::TOWER1:
				SDL_RenderCopy(RenderElement::renderer, RenderElement::texture_lib->GetTexture(TextureLib::TextureEnum::tower1), nullptr, &quad);
				break;
			case ObjectType::TOWER2:
				SDL_RenderCopy(RenderElement::renderer, RenderElement::texture_lib->GetTexture(TextureLib::TextureEnum::tower2), nullptr, &quad);
				break;
			case ObjectType::RIGHT:
				flip = (SDL_RendererFlip)1;
				SDL_RenderCopyEx(RenderElement::renderer, RenderElement::texture_lib->GetTexture(TextureLib::TextureEnum::path), nullptr, &quad_rotated, angle, nullptr, flip);
				break;
			case ObjectType::UP:
				angle = 90.0;
